public class SDESsimp {
    ...
    public static void main(String[] x){
        ...
        String[] K=k(k);
        System.out.println("K1:"+K[0]);System.out.println("K2:"+K[1]);
        System.out.println("CT:"+e(p,K[0],K[1]));
    } 

    static String e(String p,String k1,String k2){
    ...
    static String x(String a,String b){
        StringBuilder s=new StringBuilder();
        for(int i=0;i<a.length();i++)s.append(a.charAt(i)==b.charAt(i)?'0':'1');
        return s.toString();
    }

    static String[] k(String k){
        String p=t(k,P10),
        l=sh(p.substring(0,5),1)+sh(p.substring(5),1),
        k1=t(l,P8),
        l2=sh(l.substring(0,5),2)+sh(l.substring(5),2),
        k2=t(l2,P8);
        return new String[]{k1,k2};
    }

    static String t(String s,int[] p){
        StringBuilder o=new StringBuilder();
        for(int i:p)o.append(s.charAt(i-1));
        return o.toString();
    }

    static String sh(String s,int n){
