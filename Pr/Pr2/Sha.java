...
class Sha{
    public static int K[] = {0x5A827999,0x6ED9EBA1,0x8F1BBCDC,0xCA62C1D6}, H[] = {0x67452301,0xEFCDAB89,0x98BADCFE,0x10325476,0xC3D2E1F0};
    public static int L(int x, int n){
        return(x<<n)|(x>>>(32-n));
    }
        ...
        for(int i=0;i<m.length;i+=64){
            ...
            for(int v:h){
                for(int i=28;i>=0;i-=4){
                    sb.append("0123456789abcdef".charAt((v>>i)&15));
                }
            }
            return sb.toString();
        }
